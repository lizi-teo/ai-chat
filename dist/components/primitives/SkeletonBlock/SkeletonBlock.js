...
function o({ shape: o, lines: s = 3, className: c }) {
	let l = t(), u = l ? "" : "animate-shimmer", d = l ? void 0 : i;
	return o === "heading" ? /* @__PURE__ */ n("div", {
		className: e("h-6 md:h-7 w-3/4 rounded-md bg-muted", u, c),
		style: d
	}) : o === "code" ? /* @__PURE__ */ n("div", {
		className: e("rounded-lg bg-muted p-3 md:p-4 space-y-2 md:space-y-3", c),
		children: Array.from({ length: s }).map((t, r) => /* @__PURE__ */ n("div", {
			className: e("h-3 md:h-4 rounded bg-muted-foreground/15", r % 3 == 0 ? "w-4/5" : r % 3 == 1 ? "w-full" : "w-2/3", u),
			style: d
		}, r))
	}) : o === "bullet-list" ? /* @__PURE__ */ n("div", {
		className: e("space-y-2 md:space-y-3", c),
		children: Array.from({ length: s }).map((t, i) => /* @__PURE__ */ r("div", {
			className: "flex items-center gap-2 md:gap-3",
			children: [/* @__PURE__ */ n("span", { className: "size-1.5 md:size-2 rounded-full bg-muted-foreground/30 shrink-0" }), /* @__PURE__ */ n("div", {
